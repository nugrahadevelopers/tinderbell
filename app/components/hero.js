    ...
    return (
        ...
        >
            ...
            >
                ...
                <p
                    className={clsx(
                        'text-[15px] md:text-[26px] text-white font-shadow mt-10 mb-5 md:mb-10',
                    )}
                >
                    Kepada Bapak/Ibu/Saudara/i, {to ?? ''}
                </p>
                <p className={clsx(borel.className, 'text-4xl text-white font-shadow')}>
                    Reno & Anggi
                </p>
                <p
                    className={clsx(
                        'text-[13px] md:text-[22px] font-shadow text-white mt-2 md:mt-5 mb-5 md:mb-10',
                    )}
                >
                ...
                <p
                    className={clsx(
                        borel.className,
                        'text-3xl md:text-4xl text-white font-shadow mb-10',
                    )}
                >
                    31 Desember 2023
                </p>
                <Link to={'couple'} smooth={true} duration={500}>
                    <div
                        className={clsx(
                            'text-4xl font-shadow text-white animate-bounce cursor-pointer',
                        )}
                    >
                        <IoArrowDownCircle />
                    </div>
